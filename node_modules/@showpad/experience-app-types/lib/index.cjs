...
Example: 42`,type:"number"}},required:["eventAction","eventCategory","eventLabel","eventValue"]}},required:["id","sourceId"]},TrackEventPageView:{type:"object",properties:{type:{type:"string",enum:["pageview"]},touchpoint:{$ref:"jsonSchema#/definitions/PageViewTouchpoint"}},required:["touchpoint","type"]},TrackEventEvent:{type:"object",properties:{type:{type:"string",enum:["event"]},touchpoint:{$ref:"jsonSchema#/definitions/EventTouchpoint"}},required:["touchpoint","type"]},OriginalStatusEmitter:{type:"object"},StatusEmitter:{type:"object"},Label:{type:"object",properties:{value:{type:"string"},description:{type:"string"},limit:{type:"number"}},required:["value"]},OriginalLabel:{anyOf:[{$ref:"jsonSchema#/definitions/Label"},{type:"string"}]},ContentUrl:{type:"object",properties:{type:{type:"string",enum:["url"]},value:{type:"string"},description:{type:"string"}},required:["type"]},ContentFolder:{type:"object",properties:{type:{type:"string",enum:["folder"]},value:{type:"string"},description:{type:"string"}},required:["type"]},ContentChannel:{type:"object",properties:{type:{type:"string",enum:["channel"]},value:{type:"string"},description:{type:"string"}},required:["type"]},ContentAsset:{type:"object",properties:{type:{type:"string",enum:["asset"]},value:{type:"array",items:[{type:"string"}],minItems:1,maxItems:1},result:{type:"array",items:[{type:"string"}],minItems:1,maxItems:1},description:{type:"string"}},required:["type"]},ContentAssetTags:{type:"object",properties:{type:{type:"string",enum:["tags"]},value:{type:"object",properties:{or:{type:"array",items:{type:"string"}},and:{type:"array",items:{type:"string"}}}},result:{type:"array",items:[{type:"string"}],minItems:1,maxItems:1},description:{type:"string"}},required:["type"]},ContentPage:{type:"object",properties:{type:{type:"string",enum:["page"]},value:{type:"array",items:[{type:"string"}],minItems:1,maxItems:1},result:{type:"array",items:[{type:"string"}],minItems:1,maxItems:1},description:{type:"string"}},required:["type"]},ContentPageTags:{type:"object",properties:{type:{type:"string",enum:["pagetags"]},value:{type:"object",properties:{or:{type:"array",items:{type:"string"}},and:{type:"array",items:{type:"string"}}}},result:{type:"array",items:[{type:"string"}],minItems:1,maxItems:1},description:{type:"string"}},required:["type"]},Content:{anyOf:[{$ref:"jsonSchema#/definitions/ContentUrl"},{$ref:"jsonSchema#/definitions/ContentFolder"},{$ref:"jsonSchema#/definitions/ContentChannel"},{$ref:"jsonSchema#/definitions/ContentAsset"},{$ref:"jsonSchema#/definitions/ContentAssetTags"},{$ref:"jsonSchema#/definitions/ContentPage"},{$ref:"jsonSchema#/definitions/ContentPageTags"}]},Labels:{anyOf:[{$ref:"jsonSchema#/definitions/Label"},{$ref:"jsonSchema#/definitions/{[key:string]:Labels;}"}]},OriginalLabels:{anyOf:[{$ref:"jsonSchema#/definitions/Label"},{$ref:"jsonSchema#/definitions/{[key:string]:string|Label|any;}"},{type:"string"}]},Contents:{anyOf:[{$ref:"jsonSchema#/definitions/ContentUrl"},{$ref:"jsonSchema#/definitions/ContentFolder"},{$ref:"jsonSchema#/definitions/ContentChannel"},{$ref:"jsonSchema#/definitions/ContentAsset"},{$ref:"jsonSchema#/definitions/ContentAssetTags"},{$ref:"jsonSchema#/definitions/ContentPage"},{$ref:"jsonSchema#/definitions/ContentPageTags"},{$ref:"jsonSchema#/definitions/{[key:string]:ContentUrl|ContentFolder|ContentChannel|ContentAsset|ContentAssetTags|ContentPage|ContentPageTags|any;}"}]},OriginalConfigJSON:{type:"object",properties:{labels:{anyOf:[{type:"array",items:{}},{$ref:"jsonSchema#/definitions/Record<string,OriginalLabels>"}]},contents:{anyOf:[{type:"array",items:{}},{$ref:"jsonSchema#/definitions/Record<string,Contents>"}]},assets:{anyOf:[{type:"array",items:{}},{$ref:"jsonSchema#/definitions/Record<string,OriginalAsset>"}]}},required:["contents","labels"]},BaseConfigJSON:{type:"object",properties:{labels:{$ref:"jsonSchema#/definitions/Record<string,Labels>"},contents:{$ref:"jsonSchema#/definitions/Record<string,Contents>"}},required:["contents","labels"]},ConfigJSON:{description:"The ConfigJSON object is the computed result of the experience app editor which is driven by the config.json file.",type:"object",properties:{assets:{$ref:"jsonSchema#/definitions/Record<string,Asset>",description:"The maximum amount of assets returned is 2000, use getAssetsByTags if you need more results."},labels:{$ref:"jsonSchema#/definitions/Record<string,Labels>"},contents:{$ref:"jsonSchema#/definitions/Record<string,Contents>"}},required:["assets","contents","labels"]},EnrichedConfigJSON:{description:"The ConfigJSON object is the computed result of the experience app editor which is driven by the config.json file, enriched with the getAssetFileUrl() and getAssetPreviewUrl() method.",type:"object",properties:{assets:{$ref:"jsonSchema#/definitions/Record<string,EnrichedAsset>",description:"The maximum amount of assets returned is 2000, use getAssetsByTags if you need more results."},labels:{$ref:"jsonSchema#/definitions/Record<string,Labels>"},contents:{$ref:"jsonSchema#/definitions/Record<string,Contents>"}},required:["assets","contents","labels"]},ParseConfigOptions:{type:"object",properties:{localLabels:{description:"This flag only has effect in development.",type:"boolean"}}},PasswordModalConfig:{type:"object",properties:{description:{type:"string"},placeholder:{type:"string"},buttonText:{type:"string"},containerStyle:{type:"string"},descriptionStyle:{type:"string"},formStyle:{type:"string"},inputStyle:{type:"string"},buttonStyle:{type:"string"}}},UserInfo:{type:"object",properties:{id:{description:"Id is not cross platform",type:"string"},email:{type:"string"},userName:{type:"string"},fullName:{type:"string"}},required:["email","fullName","id","userName"]},"Record<string,unknown>":{type:"object"},T:{anyOf:[{type:["string","number","boolean","object"]}]},T_1:{anyOf:[{type:["string","number","boolean","object"]}]},T_2:{anyOf:[{type:["string","number","boolean","object"]}]},T_3:{anyOf:[{type:["string","number","boolean","object"]}]},"{[x:string]:JsonValue;}":{type:"object"},"{[x:string]:JsonValue|undefined;}":{type:"object"},JsonValue:{description:"Matches any valid JSON value.",anyOf:[{description:"Matches a JSON object.\n\nThis type can be useful to enforce some input to be JSON-compatible or as a super-type to be extended from. Don't use this as a direct return type as the user would have to double-cast it: `jsonObject as unknown as CustomResponse`. Instead, you could extend your CustomResponse type from it to ensure your type only uses JSON-compatible types: `interface CustomResponse extends JsonObject { \u2026 }`.",allOf:[{$ref:"jsonSchema#/definitions/{[x:string]:JsonValue;}"},{$ref:"jsonSchema#/definitions/{[x:string]:JsonValue|undefined;}"}]},{$ref:"jsonSchema#/definitions/JsonArray",description:"Matches a JSON array."},{type:["null","string","number","boolean"]}]},JsonArray:{description:"Matches a JSON array.",type:"array",items:{$ref:"jsonSchema#/definitions/JsonValue"}},Blob:{type:"object",properties:{size:{type:"number"},type:{type:"string"}},required:["size","type"]},File:{type:"object",properties:{lastModified:{type:"number"},name:{type:"string"},webkitRelativePath:{type:"string"},size:{type:"number"},type:{type:"string"}},required:["lastModified","name","size","type","webkitRelativePath"]},"{[key:string]:Labels;}":{type:"object",additionalProperties:{$ref:"jsonSchema#/definitions/Labels"}},"{[key:string]:string|Label|any;}":{type:"object",additionalProperties:{anyOf:[{$ref:"jsonSchema#/definitions/Label"},{$ref:"jsonSchema#/definitions/{[key:string]:string|Label|any;}"},{type:"string"}]}},"{[key:string]:ContentUrl|ContentFolder|ContentChannel|ContentAsset|ContentAssetTags|ContentPage|ContentPageTags|any;}":{type:"object",additionalProperties:{anyOf:[{$ref:"jsonSchema#/definitions/ContentUrl"},{$ref:"jsonSchema#/definitions/ContentFolder"},{$ref:"jsonSchema#/definitions/ContentChannel"},{$ref:"jsonSchema#/definitions/ContentAsset"},{$ref:"jsonSchema#/definitions/ContentAssetTags"},{$ref:"jsonSchema#/definitions/ContentPage"},{$ref:"jsonSchema#/definitions/ContentPageTags"},{$ref:"jsonSchema#/definitions/{[key:string]:ContentUrl|ContentFolder|ContentChannel|ContentAsset|ContentAssetTags|ContentPage|ContentPageTags|any;}"}]}},"Record<string,OriginalLabels>":{type:"object"},"Record<string,Contents>":{type:"object"},"Record<string,OriginalAsset>":{type:"object"},"Record<string,Labels>":{type:"object"},"Record<string,Asset>":{type:"object"},"Record<string,EnrichedAsset>":{type:"object"}},$id:"jsonSchema"}});var v=o(p=>{"use strict";var _=p&&p.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(p,"__esModule",{value:!0});p.initChaosTesting=p.assertDefinition=p.isDefinition=void 0;var me=_(require("ajv")),he=_(require("jsbi")),be=require("@segment/ajv-human-errors"),_e=_(require("json-schema-faker")),je=_(require("combinate")),Se=_(require("ajv-formats")),T=_(w()),ve=["string","number","bigint","boolean","symbol","undefined","object","function"],Ae=[...ve],M=new Map([["string","xxx"],["number",111],["bigint",he.default.BigInt(111)],["boolean",!0],["symbol",Symbol("xxx")],["undefined",void 0],["object",{}],["function",()=>!0]]),$="jsonSchema#/definitions/",j=new me.default({allErrors:!0});(0,Se.default)(j);j.addSchema(T.default);var Ce=(e,i)=>j.validate(`${$}${e}`,i);p.isDefinition=Ce;var Oe=(e,i)=>{if(!(0,p.isDefinition)(e,i)&&j.errors){let t=new be.AggregateAjvError(j.errors);throw new Error(t.message)}return i};p.assertDefinition=Oe;var we=e=>Object.entries(e).reduce((i,[t])=>{let r=[...i],n={...r[r.length-1]??{}};return n[t]=Ae,r.push(n),r},[]),Te=e=>e.map(je.default).reduce((i,t)=>{let r=t.map(n=>{let b={};return Object.keys(n).forEach(S=>{b[S]=M.get(n[S])}),b});return[...i,...r]},[]),Pe=(e,i)=>i.filter(t=>!(0,p.isDefinition)(e,t)),qe=e=>[...Array.from(M.values()),...e],I=(e,i)=>{let t=e;Object.keys(t).forEach(n=>{if(n===i){let b=t[n].replace($,"");t[n]=T.default.definitions[b]}typeof t[n]=="object"&&I(t[n],i)})},Ee=e=>{let i=T.default.definitions[e],t=JSON.parse(JSON.stringify(i));I(t,"$ref");let r=_e.default.generate(t);if(!r||typeof r!="object")throw new Error("JSONSchemaFaker failed to create data");let n=we(r),b=Te(n),S=Pe(e,b),fe=qe(S);return[[r],fe]};p.initChaosTesting=Ee});var V=o(a=>{"use strict";Object.defineProperty(a,"__esModule",{value:!0});a.assertConfig=a.isConfig=a.assertManifest=a.isManifest=a.assertPackage=a.isPackage=a.assertEnv=a.isEnv=void 0;var l=v(),De=e=>(0,l.isDefinition)("Env",e);a.isEnv=De;var Me=e=>(0,l.assertDefinition)("Env",e);a.assertEnv=Me;var $e=e=>(0,l.isDefinition)("Package",e);a.isPackage=$e;var Ie=e=>(0,l.assertDefinition)("Package",e);a.assertPackage=Ie;var Ve=e=>(0,l.isDefinition)("Manifest",e);a.isManifest=Ve;var Re=e=>(0,l.assertDefinition)("Manifest",e);a.assertManifest=Re;var ke=e=>(0,l.isDefinition)("Config",e);a.isConfig=ke;var xe=e=>(0,l.assertDefinition)("Config",e);a.assertConfig=xe});var k=o(g=>{"use strict";var Le=g&&g.__createBinding||(Object.create?function(e,i,t,r){r===void 0&&(r=t);var n=Object.getOwnPropertyDescriptor(i,t);(!n||("get"in n?!i.__esModule:n.writable||n.configurable))&&(n={enumerable:!0,get:function(){return i[t]}}),Object.defineProperty(e,r,n)}:function(e,i,t,r){r===void 0&&(r=t),e[r]=i[t]}),R=g&&g.__exportStar||function(e,i){for(var t in e)t!=="default"&&!Object.prototype.hasOwnProperty.call(i,t)&&Le(i,e,t)};Object.defineProperty(g,"__esModule",{value:!0});R(D(),g);R(V(),g)});var x=o(A=>{"use strict";Object.defineProperty(A,"__esModule",{value:!0});A.hasUploadStatus=void 0;var Ne=e=>e&&!!e.uploadStatus;A.hasUploadStatus=Ne});var N=o(L=>{"use strict";Object.defineProperty(L,"__esModule",{value:!0})});var J=o(s=>{"use strict";Object.defineProperty(s,"__esModule",{value:!0});s.isCustomToken=s.assertAppsDbHttpError=s.isAppsDbHttpError=s.assertV3Error=s.isV3Error=s.assertV3Token=s.isV3Token=s.assertSharedApiConfig=s.isSharedApiConfig=s.assertApiError=s.isApiError=s.assertApiConfig=s.isApiConfig=void 0;var c=v(),Je=e=>(0,c.isDefinition)("ApiConfig",e);s.isApiConfig=Je;var Ue=e=>(0,c.assertDefinition)("ApiConfig",e);s.assertApiConfig=Ue;var Be=e=>(0,c.isDefinition)("ApiError",e);s.isApiError=Be;var Fe=e=>(0,c.assertDefinition)("ApiError",e);s.assertApiError=Fe;var ze=e=>(0,c.isDefinition)("SharedApiConfig",e);s.isSharedApiConfig=ze;var He=e=>(0,c.assertDefinition)("SharedApiConfig",e);s.assertSharedApiConfig=He;var Ge=e=>(0,c.isDefinition)("V3Token",e);s.isV3Token=Ge;var We=e=>(0,c.assertDefinition)("V3Token",e);s.assertV3Token=We;var Xe=e=>(0,c.isDefinition)("V3Error",e);s.isV3Error=Xe;var Qe=e=>(0,c.assertDefinition)("V3Error",e);s.assertV3Error=Qe;var Ye=e=>(0,c.isDefinition)("AppsDbHttpError",e);s.isAppsDbHttpError=Ye;var Ze=e=>(0,c.assertDefinition)("AppsDbHttpError",e);s.assertAppsDbHttpError=Ze;var Ke=e=>typeof e=="string";s.isCustomToken=Ke});var U=o(C=>{"use strict";Object.defineProperty(C,"__esModule",{value:!0});C.SHOWPAD_API_MAP=void 0;C.SHOWPAD_API_MAP=new Map([["v3","/api/v3"],["coach","/api/learn/reporting/v3/json"]])});var B=o(d=>{"use strict";var et=d&&d.__createBinding||(Object.create?function(e,i,t,r){r===void 0&&(r=t);var n=Object.getOwnPropertyDescriptor(i,t);(!n||("get"in n?!i.__esModule:n.writable||n.configurable))&&(n={enumerable:!0,get:function(){return i[t]}}),Object.defineProperty(e,r,n)}:function(e,i,t,r){r===void 0&&(r=t),e[r]=i[t]}),P=d&&d.__exportStar||function(e,i){for(var t in e)t!=="default"&&!Object.prototype.hasOwnProperty.call(i,t)&&et(i,e,t)};Object.defineProperty(d,"__esModule",{value:!0});P(N(),d);P(J(),d);P(U(),d)});var z=o(F=>{"use strict";Object.defineProperty(F,"__esModule",{value:!0})});var G=o(H=>{"use strict";Object.defineProperty(H,"__esModule",{value:!0})});var X=o(W=>{"use strict";Object.defineProperty(W,"__esModule",{value:!0})});var Y=o(Q=>{"use strict";Object.defineProperty(Q,"__esModule",{value:!0})});var Z=o(u=>{"use strict";var tt=u&&u.__createBinding||(Object.create?function(e,i,t,r){r===void 0&&(r=t);var n=Object.getOwnPropertyDescriptor(i,t);(!n||("get"in n?!i.__esModule:n.writable||n.configurable))&&(n={enumerable:!0,get:function(){return i[t]}}),Object.defineProperty(e,r,n)}:function(e,i,t,r){r===void 0&&(r=t),e[r]=i[t]}),q=u&&u.__exportStar||function(e,i){for(var t in e)t!=="default"&&!Object.prototype.hasOwnProperty.call(i,t)&&tt(i,e,t)};Object.defineProperty(u,"__esModule",{value:!0});q(G(),u);q(X(),u);q(Y(),u)});var ee=o(f=>{"use strict";var it=f&&f.__createBinding||(Object.create?function(e,i,t,r){r===void 0&&(r=t);var n=Object.getOwnPropertyDescriptor(i,t);(!n||("get"in n?!i.__esModule:n.writable||n.configurable))&&(n={enumerable:!0,get:function(){return i[t]}}),Object.defineProperty(e,r,n)}:function(e,i,t,r){r===void 0&&(r=t),e[r]=i[t]}),K=f&&f.__exportStar||function(e,i){for(var t in e)t!=="default"&&!Object.prototype.hasOwnProperty.call(i,t)&&it(i,e,t)};Object.defineProperty(f,"__esModule",{value:!0});K(z(),f);K(Z(),f)});var ie=o(te=>{"use strict";Object.defineProperty(te,"__esModule",{value:!0})});var ne=o(re=>{"use strict";Object.defineProperty(re,"__esModule",{value:!0})});var oe=o(se=>{"use strict";Object.defineProperty(se,"__esModule",{value:!0})});var pe=o(ae=>{"use strict";Object.defineProperty(ae,"__esModule",{value:!0})});var de=o(ce=>{"use strict";Object.defineProperty(ce,"__esModule",{value:!0})});var ue=o(h=>{"use strict";Object.defineProperty(h,"__esModule",{value:!0});h.SDM_SCHEMAS=h.SDM_PREFIX=void 0;h.SDM_PREFIX="sdm-";h.SDM_SCHEMAS=`${h.SDM_PREFIX}schemas`});var le=o(m=>{"use strict";var rt=m&&m.__createBinding||(Object.create?function(e,i,t,r){r===void 0&&(r=t);var n=Object.getOwnPropertyDescriptor(i,t);(!n||("get"in n?!i.__esModule:n.writable||n.configurable))&&(n={enumerable:!0,get:function(){return i[t]}}),Object.defineProperty(e,r,n)}:function(e,i,t,r){r===void 0&&(r=t),e[r]=i[t]}),ye=m&&m.__exportStar||function(e,i){for(var t in e)t!=="default"&&!Object.prototype.hasOwnProperty.call(i,t)&&rt(i,e,t)};Object.defineProperty(m,"__esModule",{value:!0});ye(de(),m);ye(ue(),m)});var nt=exports&&exports.__createBinding||(Object.create?function(e,i,t,r){r===void 0&&(r=t);var n=Object.getOwnPropertyDescriptor(i,t);(!n||("get"in n?!i.__esModule:n.writable||n.configurable))&&(n={enumerable:!0,get:function(){return i[t]}}),Object.defineProperty(e,r,n)}:function(e,i,t,r){r===void 0&&(r=t),e[r]=i[t]}),y=exports&&exports.__exportStar||function(e,i){for(var t in e)t!=="default"&&!Object.prototype.hasOwnProperty.call(i,t)&&nt(i,e,t)},st=exports&&exports.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});exports.showpadJsonSchema=exports.assertDefinition=exports.isDefinition=void 0;y(k(),exports);y(x(),exports);y(B(),exports);y(ee(),exports);y(ie(),exports);y(ne(),exports);y(oe(),exports);y(pe(),exports);y(le(),exports);var ge=v();Object.defineProperty(exports,"isDefinition",{enumerable:!0,get:function(){return ge.isDefinition}});Object.defineProperty(exports,"assertDefinition",{enumerable:!0,get:function(){return ge.assertDefinition}});var ot=w();Object.defineProperty(exports,"showpadJsonSchema",{enumerable:!0,get:function(){return st(ot).default}});
